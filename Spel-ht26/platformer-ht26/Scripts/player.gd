...
func _walk_state(delta: float) -> void:
	...
	#3 kontroll om rörelse lett till state-förändring
	
	if not is_on_floor() and want_to_jump:
		_enter_air_state(false)
